  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-50 font-sans selection:bg-primary/30 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-primary/20 rounded-full blur-[150px] animate-pulse"></div>
      ...
      <div className="relative w-full max-w-[480px] animate-fade-in group">
        ...
        <div className="relative bg-slate-900/60 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-10 md:p-14 shadow-2xl overflow-hidden">
          ...
          <div className="text-center mb-12 relative z-10">
            ...
            <h1 className="text-4xl font-black tracking-tight text-white mb-3">Join the Hub</h1>
            <p className="text-slate-500 font-bold text-sm tracking-wide uppercase">Initialize Simulation Pilot</p>
          </div>
          
          <form onSubmit={handleSignup} className="space-y-6 relative z-10">
            <div className="space-y-2">
              <label className="text-[11px] uppercase tracking-[0.2em] font-black text-slate-500 ml-1">Universal Identity</label>
              <input
                type="text"
            ...
            <div className="space-y-2">
              <label className="text-[11px] uppercase tracking-[0.2em] font-black text-slate-500 ml-1">Access Protocol</label>
              <input
                type="password"
                className="w-full bg-slate-950/50 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all"
                value={password}
          ...
          <p className="mt-10 text-center text-xs font-bold text-slate-600 uppercase tracking-widest relative z-10">
            Registered Already?{" "}
            <Link href="/auth/login" className="text-primary hover:text-blue-400 transition-colors ml-1">
              Engage Auth Engine
            </Link>
          </p>
        </div>
